package com.zkml.meetingtablecard.view.calendar;
...
public class MeizuWeekView extends WeekView {
    ...
    public MeizuWeekView(Context context) {
        ...
        mRadio = dipToPx(getContext(), 0);
        mPadding = dipToPx(getContext(), 0);
        Paint.FontMetrics metrics = mSchemeBasicPaint.getFontMetrics();
        mSchemeBaseLine = mRadio - metrics.descent + (metrics.bottom - metrics.top) / 2 + dipToPx(getContext(), 0);
    }
