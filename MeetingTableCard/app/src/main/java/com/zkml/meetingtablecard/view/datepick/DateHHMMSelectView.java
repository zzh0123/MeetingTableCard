 ...
 * 有开关控制点击确认 是否关闭对话框
 */
public class DateHHMMSelectView extends BaseDialog implements
    ...
    public DateHHMMSelectView(Context context, int startTime) {
        super(context, R.layout.car_easy_rent_dialog_picker_center);
        this.context = context;
        this.startTime = startTime;
    }

    public DateHHMMSelectView(Context context, int startTime, String strTitle) {
        super(context, R.layout.car_easy_rent_dialog_picker_center);
        this.context = context;
        this.startTime = startTime;
...
//        }
    ...
    public void onClick(View v) {
        ...
        if (v == btnSure) {
            if (onTimePickListener != null) {
                onTimePickListener.onClick(selectDate, Integer.parseInt(selectYear), Integer.parseInt(selectMonth), Integer.parseInt(selectDay), selectHour, selectMinutes, mIsStart);
    ...
    public interface OnTimePickListener {
        public void onClick(int selectDate, int year, int month, int day, String hour, String minute, boolean isStart);
    }
