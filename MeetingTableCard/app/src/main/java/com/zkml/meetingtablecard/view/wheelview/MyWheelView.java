package com.zkml.meetingtablecard.view.wheelview;
...
public class MyWheelView extends View {
    ...
    private int[] SHADOWS_FONT_SIZE = new int[]{14, 16, 18};
    private int[] SHADOWS_COLORS = new int[]{0x7fffffff, 0x7fffffff, 0x7fffffff};
    private int currentItem = 0;
    private int visibleItems = DEF_VISIBLE_ITEMS;
    private int itemHeight = 0;
    private Drawable centerDrawable;
    private int wheelBackground = R.drawable.wheel_bg1;
    ...
    private void drawShadows(Canvas canvas) {
        ...
        int height = (getHeight() - 2 * offset) / 2;
        //*/
        //int height = 2 * getItemHeight();
        //*/
        topShadow.setBounds(0, 0, getWidth(), height);
        topShadow.draw(canvas);
        bottomShadow.setBounds(0, getHeight() - height + 1, getWidth(), getHeight());
