package com.zkml.meetingtablecard.view.FileView;
    ...
    public void displayFile(File mFile) {
        ...
        if (mFile != null && !TextUtils.isEmpty(mFile.toString())) {
            ...
            if (!bsReaderTempFile.exists()) {
                LogUtil.i("zzz1", "准备创建/storage/emulated/0/TbsReaderTemp！！");
                boolean mkdir = bsReaderTempFile.mkdir();
                if(!mkdir){
                    LogUtil.e("zzz1","创建/storage/emulated/0/TbsReaderTemp失败！！！！！");
                }
            }

            //加载文件
            Bundle localBundle = new Bundle();
            LogUtil.i("zzz1", mFile.toString());
