package com.zkml.meetingtablecard.utils.httpserver.upload;

import android.content.Context;
import android.os.Message;
import android.text.TextUtils;

import com.zkml.meetingtablecard.utils.httpserver.L;
import com.zkml.meetingtablecard.utils.httpserver.listener.UploadListener;
import com.zkml.meetingtablecard.utils.httpserver.task.PriorityAsyncTask;
...
public class UploadTask<T> extends PriorityAsyncTask<Void, UploadInfo, UploadInfo> {
    ...
    protected UploadInfo doInBackground(Void... params) {
        ...
        Response response;
        try {
            PostRequest postRequest = HttpConnUtils.post(mUploadInfo.getUrl());
